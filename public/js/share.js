		...
		goodshare = {
			...
			doit: function(_element, _options) {
				...
				*/
				...
				var self = goodshare, 
					options = $.extend({
						type:	'vk',
						url:	location.href.replace('sonku_', ''),
			...
			*/
			...
			ok: function(_options) {
				...
				return 'http://ok.ru/dk?st.cmd=addShare&st.s=1'
			...
			*/
			...
			viber: function(_options) {
				...
				var options = $.extend({
					url:    location.href.replace('sonku_', ''),
					title:  document.title.length>150?document.title.substr(0, 150)+'...':document.title,
					text:   ''
				}, _options);

				return 'viber://forward?text='
					+ encodeURIComponent(options.title)
					+ encodeURIComponent(' '+options.url);
			},
			
			tlg:function(_options){
				var options = $.extend({
					url:    location.href.replace('sonku_', ''),
					title:  document.title,
					text:   ''
				...
				return 'https://telegram.me/share/url?text='
					+  encodeURIComponent(options.title)+'&url='+ encodeURIComponent(options.url); 
				
				//return 'https://t.me/superkg_official';
			},
